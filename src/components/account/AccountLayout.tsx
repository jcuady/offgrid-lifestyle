...
export function AccountLayout({
  ...
  return (
    <div className="min-h-screen bg-offgrid-cream pt-20 sm:pt-24">
        ...
        <div className="grid gap-6 lg:grid-cols-[clamp(15rem,22vw,17rem)_1fr] lg:gap-10">
          <aside className="min-w-0 lg:sticky lg:top-24 lg:self-start">
            ...
            <nav
              ...
              className="mt-3 flex gap-2 overflow-x-auto pb-1 lg:flex-col lg:gap-1.5 lg:overflow-visible lg:pb-0"
            >
              {NAV.map((item) => {
