...
export const CMS_ROUTE_OPTIONS: { value: string; label: string; group: string }[] = [
  ...
  { value: "/collections", label: "Shop by collection (page)", group: "Store" },
  ...
  { value: "/community", label: "Events and Sports", group: "Site" },
  { value: "/events", label: "Events and Sports (legacy → community)", group: "Site" },
